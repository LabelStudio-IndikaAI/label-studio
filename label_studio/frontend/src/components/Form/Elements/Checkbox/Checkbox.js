...
import './Checkbox.styl'; // Styles specific to Checkbox

const Checkbox = forwardRef(({ className, label, labelProps, description, checked, defaultChecked, onChange, validate, required, skip, ...props }, ref) => {
  const rootClass = cn('checkbox'); // Class name specific to Checkbox
